...
image_generator_tool = FunctionTool(
    ...
    parameters=[
        Parameter(name="size", type="string", description="Image size in format WxH"),
        Parameter(name="background_color", type="string", description="Background color name or hex code"),
        Parameter(name="base_image_url", type="string", description="Optional URL of base image to use"),
        Parameter(name="text_elements", type="array", description="List of text elements to add to the image"),
        Parameter(name="image_overlays", type="array", description="List of image overlays to add"),
        Parameter(name="additional_params", type="object", description="Additional parameters like filters")
    ]
)
...
image_generator_tool.implementation = generate_social_image
