...
process_copywriter_task_tool = {
    ...
    "parameters": {
        ...
        "brand_document": {"type": "object", "description": "The brand document containing brand guidelines and details"},
        "post_plan_document": {"type": "object", "description": "The post plan document containing content requirements"}
    },
    "implementation": process_copywriter_task_impl
}
